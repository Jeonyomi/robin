  ...
  return (
    <div className="page-shell">
      ...
      <section className="scope-banner compact-scope">
        ...
        <p className="scope-note">{meta.observationBoundary ?? "The gate requires a recent successful index, a completed registry rotation, and verified comparable observation exposure for the canonical tokens and selected window."}</p>
      </section>
