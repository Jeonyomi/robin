...
export default function LpExplorer() {
  ...
  return <div className="leaders-shell">
    ...
    <section className="leaders-panel" aria-label="LP NFT leaderboard" aria-busy={loading}>
      ...
      <p className="leaders-observation"><strong>SHARED VERIFIED SNAPSHOT</strong> · not a live feed; collected separately about every 5 minutes, at most 10 minutes old. Refresh reads stored data without RPC calls.</p>
      {visibleBoard && collectionDelayed && <p role="status" className="leaders-risk">Collector update delayed. The displayed verified observation is still within the ten-minute limit.</p>}
