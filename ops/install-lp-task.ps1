...
$task = New-ScheduledTask -Action $action -Trigger $trigger -Principal $principal -Settings $settings -Description 'Dedicated Robin LP snapshot publisher. No changes to RobinSync. Requires this user session and WSL.'
